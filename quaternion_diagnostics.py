...
def main() -> None:
    ...
    ap.add_argument("input", type=Path, help="CSV input (must include timestamp_ms and org_quat_w/x/y/z)")
    ...
    ap.add_argument("--outdir", type=Path, default=Path("analysis/quaternion_diagnostics"), help="Output directory")
