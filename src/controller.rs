...
pub struct Controller {
    ...
    set_imu_lpf_strength: qt_method!(fn(&self, strength: f64)),
    ...
    set_imu_median_filter_strength: qt_method!(fn(&self, strength: f64)),
...
impl Controller {
    ...
    wrap_simple_method!(set_imu_lpf_strength, v: f64; recompute; chart_data_changed);
    ...
    wrap_simple_method!(set_imu_median_filter_strength, v: f64; recompute; chart_data_changed);
