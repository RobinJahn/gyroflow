...
def main() -> None:
    ...
    p.add_argument("--out", type=Path, default=None, help="Output HTML path (default: analysis/lpf_compare/output/<csv_stem>_viz_interactive.html)")
    ...
    if args.out is None:
        out = Path("analysis/lpf_compare/output") / f"{args.csv_file.stem}_viz_interactive.html"
    else:
        out = args.out
