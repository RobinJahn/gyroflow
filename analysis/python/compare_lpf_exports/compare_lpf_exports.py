...
def main() -> None:
    ...
    p.add_argument("original_csv", nargs="?", type=Path, default=DATA_DIR / "export.csv", help="Original CSV")
    p.add_argument("lp350_csv", nargs="?", type=Path, default=DATA_DIR / "export_LP350.csv", help="LP350 CSV")
    p.add_argument("lp2_csv", nargs="?", type=Path, default=DATA_DIR / "export_LP2.csv", help="LP2 CSV")
    p.add_argument("--outdir", type=Path, default=SCRIPT_DIR / "output", help="Dedicated output folder")
